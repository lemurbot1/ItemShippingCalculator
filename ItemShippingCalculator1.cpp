...
// Bonus destination: PLUTO
const double PLU1 = 3000.00, PLU2 = 6000.00, PLU3 = 12000.00;
...
int main()
{
    ...
    cout << "Please enter destination. (usa/can/aus/pluto)" << setw(19) << ":"; // NOTE bonus destination: Pluto
    cin >> destination;
